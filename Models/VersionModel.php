...
class Version{
	...
	public function __construct( SourceTextLibrary $SourceTextLibrary, Array $RawVersion = array() ){
		$this->SourceTextLibrary = $SourceTextLibrary;	// Passed by Reference
		...
		if( array_key_exists( 'Options', $RawVersion ) ){
			if( array_key_exists( 'SmallCaps', $RawVersion['Options'] ) ){
				...
				// $this->SourceTextLibrary->Parser->setSmallCapsText( $this->getSmallCaps() );
			}

			if( array_key_exists( 'Selah', $RawVersion['Options'] ) ){
				$this->setSelah( $RawVersion['Options']['Selah'] );
				// $this->SourceTextLibrary->Parser->setSelahHTML( $this->getSelah() );
			}
		}
	...
	function setLicense( string $License ){
		...
		// $this->LicenseHTML = $this->SourceTextLibrary->line( $License );
